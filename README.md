...
After cloning the repository, you can run the pipeline using Docker. To do so, you can execute following commands in sequence.
...
Please note, Docker is used just to simplify environment setup and it is not required. The solution itself can be executed on any PostgreSQL instance, after creation of DB (e.g. ats_data), successful connection and execution mentioned SQL scripts in aforementioned order.
